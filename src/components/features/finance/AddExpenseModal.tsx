...
import { EXPENSE_CATEGORIES, TRANSACTION_STATUS_OPTIONS } from '@/constants/finance';
  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        <Select label="Статья расходов" value={category} onChange={(event) => setCategory(event.target.value)}>
